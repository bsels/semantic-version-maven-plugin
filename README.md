...
| `versioning.git.enabled`           | `boolean` | `false`                                                           | Enable automatic Git operations (staging and committing changes)                                                                                                                                                                    |
...
| `versioning.update.scripts`        | `String`      | `-`                                                       | Script paths to execute per updated module, separated by the OS path separator. Each script runs in the module directory with `CURRENT_VERSION`, `NEW_VERSION`, `DRY_RUN`, `GIT_STASH`, `EXECUTION_DATE` (YYYY-MM-DD) environment variables.                               |
| `versioning.git.enabled`           | `boolean`     | `false`                                                   | Enable automatic Git operations (staging and committing changes)                                                                                                                                                                                                           |
...
| `versioning.git.enabled` | `boolean` | `false`           | When `true`, automatically stages and commits changes to Git repository                                                                                                                                                                                                                           |
